                    ...
                    <div id="js-home-feed-list" class="zh-general-list topstory clearfix" data-init="{&quot;params&quot;: {}, &quot;nodename&quot;: &quot;TopStory2FeedList&quot;}" data-delayed="true" data-za-module="TopStoryFeedList">
                        ...
                        " feed-item-a="" data-type="a" id="feed-2" data-za-module="FeedItem" data-za-index="">
                            ...
                            <div class="feed-item-inner">
                                <#--此处的代码需要改进，如果user.createdDate为空，则出现异常-->
                                <#--${vo.user.id!''},${vo.user.name!''},${vo.user.password!''},${vo.user.salt!''},${vo.user.headUrl!''}<br />-->
                                <#--${vo.question.title!""},${vo.question.content!""},${vo.question.userId!""},${vo.question.createdDate?string('yyyy-MM-dd HH:mm:ss')},${vo.question.commentCount!""}-->
                                    <#--${date.format("yyyy-MM-dd HH:mm:ss", vo.question.created_date!"")}-->
                                    <#--${vo.question.created_date!""}-->
                                <div class="avatar">
